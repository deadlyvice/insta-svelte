...
<style>
  ...
  .aspect-16-9 { position: relative; width:100%; padding-top:56.25%; overflow:hidden; border-radius:8px; }
  .aspect-1-1  { position: relative; width:100%; padding-top:100%; overflow:hidden; border-radius:8px; }
